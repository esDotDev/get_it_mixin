...
This package offers a set of mixin types that make it very easy to bind your Widgets to the data stored in GetIt.
...
In order to keep `GetIt` free from Flutter dependencies I chose to write a separate package using mixins.
